...
class ParksControllerTest < ActionController::TestCase
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post :create, park: { address: @park.address, cleanliness: @park.cleanliness, imgageurl: @park.imgageurl, name: @park.name, postalcode: @park.postalcode, welllit: @park.welllit }
    end
  ...
  test "should update park" do
    patch :update, id: @park, park: { address: @park.address, cleanliness: @park.cleanliness, imgageurl: @park.imgageurl, name: @park.name, postalcode: @park.postalcode, welllit: @park.welllit }
    assert_redirected_to park_path(assigns(:park))
  end
